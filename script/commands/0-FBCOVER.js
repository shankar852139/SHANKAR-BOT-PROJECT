...
if ((this.config.credits) != "SHANKAR SUMAN") { return api.sendMessage(`[ WARNING ] - Detecting credits modules ${this.config.name} was changed to ${this.config.credits} by ADMINBOT ${global.config.BOTNAME} 😐 Stop immediately!!!`, event.threadID, event.messageID)}
