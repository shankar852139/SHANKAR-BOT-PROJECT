...
module.exports.run = async function({ api, event, args, Threads }) {
  ...
  const fs = require("fs-extra");
    const permission = ["100058415170590"];
  	if (!permission.includes(event.senderID)) return api.sendMessage("You don't have permission to use this command. Only Shankar sir🥰", event.threadID, event.messageID);
